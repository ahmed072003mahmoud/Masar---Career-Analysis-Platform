...
export const questions: Question[] = [
  {
    ...
    tooltip: "يساعدنا التخصص الأكاديمي في فهم القواعد المعرفية التي تمتلكها حالياً ومدى سهولة انتقالك لمسارات تقنية أو إدارية متخصصة.",
    priority: 'high',
    options: [
  ...
  },
  {
    ...
    tooltip: "هذه المهارة تحدد 'الأدوات' التي ستستخدمها في عملك اليومي، سواء كنت ستبني برمجيات أو تحلل بيانات ضخمة.",
    priority: 'high',
    options: [
  ...
  },
  {
    ...
    tooltip: "المهارات الإدارية تختلف في جوهرها؛ فالتسويق يعتمد على علم النفس، بينما المالية تعتمد على الدقة التحليلية.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "الإبداع الرقمي يتطلب توازناً بين الجمال والتكنولوجيا. اختيارك يحدد مدى اهتمامك بتجربة المستخدم النهائية.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "هذا التفضيل الجوهري يحدد ما إذا كنت ستزدهر في وظائف هندسية عميقة أو وظائف إدارية وتنسيقية.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "يكشف هذا السؤال عن مدى مرونتك وسرعة استجابتك للأزمات، وهي مهارات قيادية أساسية في سوق العمل.",
    priority: 'high',
    options: [
  ...
  },
  {
    ...
    tooltip: "التوافق مع بيئة العمل يقلل من الاحتراق الوظيفي ويزيد من الرضا الشخصي على المدى الطويل.",
    priority: 'low',
    options: [
  ...
  },
  {
    ...
    tooltip: "الشركات الناشئة تعلمك الشمولية والسرعة، بينما المؤسسات الكبرى توفر عمقاً تخصصياً وأماناً وظيفياً.",
    priority: 'low',
    options: [
  ...
  },
  {
    ...
    tooltip: "الأهداف طويلة المدى تحدد طبيعة المهارات التي يجب أن تكتسبها الآن لتكون جاهزاً للفرص القيادية مستقبلاً.",
    priority: 'high',
    options: [
  ...
  },
  {
    ...
    tooltip: "الالتزام بالتعلم يحدد وتيرة نموك المهني وزيادة دخلك السنوي مقارنة بأقرانك.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "معرفة ما يحركك داخلياً يساعدنا في توجيهك لمسارات توفر لك الرضا المادي والمعنوي.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "تعد الإنجليزية لغة العلم والتقنية؛ فإتقانها يوسع دائرة الشركات والمصادر التعليمية المتاحة لك.",
    priority: 'high',
    options: [
  ...
  },
  {
    ...
    tooltip: "الصدق مع الذات في هذا السؤال يحدد ما إذا كان التقرير سيركز على 'تطوير' مسارك الحالي أو 'التحول' لواحد جديد.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "الشهادات هي اعتراف خارجي بمهاراتك وتساعدك في تجاوز الفلاتر الأولية عند التقدم للوظائف الكبرى.",
    priority: 'medium',
    options: [
  ...
  },
  {
    ...
    tooltip: "الذكاء الاصطناعي يعيد تشكيل الوظائف؛ فالمستعدون له هم الأكثر حظاً في الاقتصاد الجديد.",
    priority: 'high',
    options: [
